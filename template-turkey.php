...
<br>
<div class="container">
    <div class="topspeak"><img src="<?php echo sepehr;?>/images/turkey/top.png" class="img-responsive text-center" alt=""></div>
</div>
<br>
    ...
    <div class="col-md-10">
        <form action="http://zabankadehsepehr.com/%d8%ab%d8%a8%d8%aa-%d9%85%d8%b4%d8%ae%d8%b5%d8%a7%d8%aa-%d8%af%d8%a7%d9%86%d8%b4%d8%ac%d9%88/" method="post">
            <div class="tab1">
                <div class="col-md-2"><img src="<?php echo sepehr;?>/images/turkey/H1.png" class="img-responsive" alt=""></div>
                <div class="col-md-10">
                    <?php
                    $args = array(
                        'post_type' => 'course',
            ...
            <div class="tab2">
                <div class="col-md-2"><img src="<?php echo sepehr;?>/images/turkey/H2.png" class="img-responsive" alt=""></div>
                <div class="col-md-10">
                    <?php
                    $args = array(
                        'post_type' => 'course',
            ...
            <div class="clearfix"></div>
            <div class="tab2">
                <div class="col-md-2"><img src="<?php echo sepehr;?>/images/turkey/H3.png" class="img-responsive" alt=""></div>
                <div class="col-md-10">
                    <?php
                    $args = array(
                        'post_type' => 'course',
